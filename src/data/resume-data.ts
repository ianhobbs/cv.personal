...
export const RESUME_DATA: ResumeData = {
  ...
  exhibitions: [
    { title: "Consequences", venue: "Grace Cossington Smith Gallery", year: "2022" },
    ...
    { title: "Chester Nealie Etched in Fire", venue: "Ron Sang Publications, NZ", year: "2016" },
    { title: "Making Halo", venue: "Frasers Setsui / Partridge", year: "2012" },
    { title: "Last Word", venue: "Bundanon Trust, Nowra NSW", year: "2012" },
    { title: "Honouring Names Tent Embassy", venue: "Sydney Opera House", year: "2012" },
    ...
    { title: "Liz Williamson: Textiles", venue: "Craft Council NSW", year: "2009" },
    { title: "Matthew and Others", venue: "Campbelltown Art Centre", year: "2006" },
    { title: "Ali or 3li", venue: "Casula Powerhouse", year: "2005" },
    { title: "Welcome to my Loungeroom", venue: "Penrith and Lewers Bequest Regional Gallery", year: "2004" },
    { title: "Art First", venue: "Qdeck, Mt Penang NSW", year: "2004" },
    { title: "Selenium Revisited", venue: "Marrickville Art Space", year: "2002" },
    ...
    { title: "Luminous Insects", venue: "Fringe Festival, Sydney", year: "1997" },
    { title: "Banalities", venue: "Performance Space / Side on Gallery", year: "1997" },
    { title: "Treasures of the Art Trail", venue: "Regional Galleries of NSW", year: "1994-1996" },
    { title: "Shh/Ratios of Luminance", venue: "Perspecta, Performance Space, Sydney", year: "1988" },
